...
export type TelegramWebviewSerializedEvent<
    T extends keyof TelegramWebviewEventMap
> = {
    eventType: T;
...
export type TelegramWebviewEvent =
    TelegramWebviewSerializedEvents[keyof TelegramWebviewEventMap];
export type TelegramWebviewEventCallback = (
    event: TelegramWebviewEvent
) => void;
